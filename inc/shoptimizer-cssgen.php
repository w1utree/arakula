...
if ( ! function_exists( 'shoptimizer_typography2_css' ) ) {
	...
	function shoptimizer_typography2_css() {
		...
		$css->set_selector( '.site .menu-primary-menu-container > ul > li > a, .site .site-header-cart .cart-contents' );
		...
		// Widget Title Font.
		$css->set_selector( '.site .widget .widget-title, .site .widget .widgettitle' );
...
function shoptimizer_enqueue_dynamic_css() {
	...
	if ( is_customize_preview() ) {
		...
		wp_add_inline_style( 'shoptimizer-dynamic-style', wp_strip_all_tags( $css ) );
	}
